...
<head>
    ...
    <title>Cotización — Concesionaria Automotriz</title>
...
<header class="dash-navbar">
    ...
    <nav class="dash-nav-center">
        ...
        <a href="#" class="nav-link active">Cotización</a>
...
<main class="dash-main">
    ...
    <div class="gest-header">
        ...
        <div class="gest-search-inline">
            <input class="gest-input" type="text" placeholder="Buscar cliente..." oninput="filtrar(this.value)" />
            <svg class="search-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line>
            </svg>
        </div>

        <button class="btn-cotizacion">+ Nueva cotización</button>
    </div>
