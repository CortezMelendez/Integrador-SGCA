...
<header class="dash-navbar">
    ...
    <nav class="dash-nav-center">
        ...
        <a href="${pageContext.request.contextPath}/pages/asesorPages/cotizacion.jsp" class="dash-nav-link">
            Registrar Cotización
        </a>

        <a href="${pageContext.request.contextPath}/pages/asesorPages/historial.jsp" class="dash-nav-link">
            Historial de ventas
        </a>
