...
<body>
  ...
  <c:if test="${not empty param.error}">
    <script>window.addEventListener('DOMContentLoaded', () => alert('No se pudo guardar el empleado. Verifica que el correo, RFC, CURP y teléfono no estén ya registrados.'));</script>
  </c:if>
