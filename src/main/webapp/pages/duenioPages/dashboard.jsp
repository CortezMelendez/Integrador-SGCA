...
<main class="dash-main">
    <div class="dash-section-header">
        ...
        <div class="dash-gestion" id="dashGestion">
            ...
            <div class="gestion-menu" id="gestionMenu" role="menu">
                <a href="gestionServicios.html" class="gestion-menu-item" role="menuitem">
                ...
                <a href="gestionEmpleados.html" class="gestion-menu-item" role="menuitem">
                ...
                <a href="gestionClientes.html" class="gestion-menu-item" role="menuitem">
                ...
                <a href="gestionAutos.html" class="gestion-menu-item" role="menuitem">
    ...
    <div class="dash-quick">
        ...
        <a href="historial.html" class="quick-card">
            <span class="quick-icon"></span>
