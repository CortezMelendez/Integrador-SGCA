...
public class VehiculosDao {
    public List<VehiculosBean> listar(){
        ...
        try (Connection conn = Conexion.getConexion();
            ...
            while (rs.next()) {
                VehiculosBean v = mapearVehiculo(rs);
                lista.add(v);
            }
    ...
    // Metodo auxiliar para no repetir mapeos de ResultSet
        private VehiculosBean mapearVehiculo(ResultSet rs) throws SQLException {
            ...
            // Se inyecta el Modelo en el Vehículo
            v.setModelos(modelo);
            return v;
        }
